exports.firstTimeItems = {
  latest: [
    {
      src: '/images/tutorial_clips/v1/anim_1.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim_2.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim_3.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim_4.gif',
      header: 'You can also create your own PopIts by clicking the burger menu, then click "Pop It!", then click "Make your own!" From here you can create your PopIt. You can add images, gifs, and text.',
    },
    {
      src: '/images/tutorial_clips/v1/anim_5.gif',
      header: 'When you are ready to submit your PopIt, you can either click "Submit" to submit it right away, or you can click "Preview" to see what your PopIt will look like. Before choosing one of those options, you will be asked to pick a size for your PopIt. The default is 100, which covers up about 5% of the canvas, but you have a choice to make it smaller if you wish.',
    },
    {
      src: '/images/tutorial_clips/v1/anim_6.gif',
      header: 'After you submit your PopIt, you will be asked if you want to make more PopIts, or if you want to go back to the home page. Back at the home page, you can find your submitted PopIt by going to the PopIt menu, and clicking "My PopIts" or you can search for your PopIt by the name that the server generated.',
    },
    {
      src: '/images/tutorial_clips/v1/anim_7.gif',
