exports.firstTimeItems = {
  latest: [
    ...
    {
      src: '/images/temp/longgif.gif',
      header: 'Also, there is a small chance that the data number got altered. In this case, try refreshing the list, and then type a dot before your data number, and search again.',
    },
    {
      src: '/images/temp/longgif.gif',
