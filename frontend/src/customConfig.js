exports.firstTimeItems = {
  latest: [
    {
      src: '/images/tutorial_clips/v1/anim1.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim2.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim6.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim9.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim10.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim11.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim12.gif',
    ...
    {
      src: '/images/tutorial_clips/v1/anim13.gif',
